...
## Background
This is the day 1 computer lab session for quantitative genetic analysis. You can find the course website [here](https://wheatme.wixsite.com/wheatme/workshop-2019). The goal of this exercise is to set up mixed model equation (MME) and obtain solutions for best linear unbiased estimator (BLUE) and best linear unbiased prediction (BLUP).
...
## lme4 R package
We can conform our resutls using the [lme4](https://cran.r-project.org/web/packages/lme4/index.html) R package. 
```{r, eval=FALSE, echo=TRUE}
...
The variance components can be also obtained. 
```{r, eval=FALSE, echo=TRUE}
